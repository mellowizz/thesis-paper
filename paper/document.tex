...
of the \gls{eagle} and if necessary certain \gls{eunis} within the \gls{natflo}
project.
...
and training data for certain categories which serve as class labels for the
