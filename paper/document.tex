...
Nieland2015a} and have been used for a habitat quality tool showing trends and indicators led to the discovery of relationships between phenomena \citep{Perez-Luque2015}. % Bitte zitiere hier
% auch unser paper: Using ontological inference and hierarchical matchmaking to
% overcome semantic heterogeneity in remote sensing-based biodiversity
% monitoring

% @article{Nieland2015a,
...
% 	author = {Nieland, Simon and Moran, Niklas and Kleinschmit, Birgit and F\"{o}rster, Michael},
% 	doi = {10.1016/j.cageo.2015.08.006},
% 	file = {:C$\backslash$:/Users/Nieland/AppData/Local/Mendeley Ltd./Mendeley Desktop/Downloaded/Nieland et al. - 2015(3).pdf:pdf},
% 	issn = {00983004},
% 	journal = {Computers \& Geosciences},
% 	keywords = {Generalisation,NATURA 2000,Nature conservation,OWL2,Remote sensing,Spatial reclassification},
% 	month = nov,
% 	pages = {86--95},
% 	title = {{An ontological system for interoperable spatial generalisation in biodiversity monitoring}},
% 	url = {http://www.sciencedirect.com/science/article/pii/S0098300415300327},
% 	volume = {84},
% 	year = {2015}
% }
...
\end{itemize}
% Ich habe die beschreibung des Testgebietes doch wieder in die Methode gemacht.
% Ich finde das passt so besser.
\section{Method}
...
\end{table}
%Du solltest aus der Tabelle die Klassen entfernen, die du bei den Results nicht
% mehr drin hast.
%\subsection{Segmentation}
%\label{subsec:segmentation}
All described processes are based on a pre-segmentation based on GEOBIA.
...
Digital Surface Model (DSM) (resolution 0.5m) using automated stereo matching and therefore 
...
updated every year and a soil map which is based on the ALKIS 
(Amtliches Liegenschaftskaster Informationssystem- Automated Land 
Registration Map) (partially updated 2015). The actual classification process is
based on two RapidEye Scenes (Year:2014) and indices of the DTM, DEM and orthophotos.
...
% In der Graphik w�rde ich Parameters durch indicators ersetzen.
\begin{figure}
...
% Du musst noch schreiben, dass du als erstes in Cal und val trennst!
%\subsubsection{SeATH}
...
%Hier vielleicht noch ein einleitender Satz: Based on the training data,
% different data mining algorithms are used to generate rules for the actual
...
\end{figure}
%Hier muss noch rein wie SeATH funktioniert. Hattest du das nicht schon irgendwo
% geschrieben?
...
%hier bitte das Layout verändern, dass es besser auf eine Seite passt.
...
% Du vermischt results und discussion sehr stark. Bitte beschreibe hier
% lediglich die Ergebnisse OHNE Bewertung und Erklärung! Das kommt in die
% Discussion!
\begin{table}
    \centering
...
%classes. The presence of orchards i KEINE ERKLÄRUNG IN DIE ERGEBNISSE=> KOMMT
% IN DISSCUSSION
