...
% cheaper RS, higher res makes it possible? 
%% NATFLO automated map-making
...
result concepts from EAGLE are used. We are then able to translate from OSIRIS
(Rhineland-Paltinate biotope map system) and the embodied expert knowledge
therein to EUNIS where it then can be further understood by other experts and
compared with habitats in other member states.
