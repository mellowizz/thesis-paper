...
\centering
  ...
  \rot{usage} & \rot{usage intensity} & \rot{depression} & \rot{immature soil} & \rot{hydromorphic} &
...
\multirow{4}{*}{Mesic grasslands} 
    & E2   &  mesic &   			& $\times$ 	& low &   &   &   & $\times$\\ 
    & E2.1 &  mesic & $\times$     	& mowing	&   &   &   & $\times$ &\\ 
    & E2.3 &  mesic &   & $\times$ 	& $\times$ &   &   &   &\\
    & E2.7 &  mesic &   &   & $\times$ & $\times$ &   &   & \\
\multirow{3}{*}{Wet grasslands}
    & E3   & wet & * & * & * & $\times$ & $\times$ & $\times$ & species rich \\
    & E3.4 & wet & * & * & * & $\times$ & $\times$ & $\times$ & species rich \\
    & E3.5 & wet & * & * & * & $\times$ & $\times$ & $\times$ & species rich \\
\end{tabular}
%\end{center}
