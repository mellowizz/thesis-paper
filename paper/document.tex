...
%Was ist Reasoning?  Du musst auch noch erklären was data mining/ %machine
% learning ist
%und die in der Fernerkundung gängigsten Algorithmen %erwähnen (SVM, RF, BRT,
%DT) Bitte alle mit Quelle!
