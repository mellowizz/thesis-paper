...
Hearn_2011, Nieland2015a}. Furthermore, habitat status is mostly 
generated in 
...
manual habitat mapping \citep{Arvor2013, Nieland2015a, Nieland2015b}. Therefore 
...
be detected by our data and aggregated to form EUNIS classes. 
\begin{table}
\centering
...
Surface Model (DSM) (resolution 0.5m) using automated stereo matching and
therefore represent the basis for all segmentation and classification
procedures. The DTM and DEM was produced using LiDAR ASCII point clouds acquired
