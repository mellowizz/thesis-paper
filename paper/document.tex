...
% their corresponding thresholds using logical ANDs. We do this for every 
class, 
...
dtm/dem & orthophotos\\
aspect & red\\
catchment area (caar) & blue\\
convergence index (coin) & green\\
curvature classification & bare area index\\
DDVI & Normalized Difference Vegetation Index\\
