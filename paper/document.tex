...
Geographic Object-Based Image Analysis(GEOBIA) to reduce the subjectivity,
reduce costs and increase temporal resolution by saving time.
\\
...
interoperability has been has been demonstrated by \citep{Nieland2015}.
\\
The addition of fuzzy data types 
into OWL2 and the development of a fuzzy spatial reasoner holds great promise 
for the future of GEOBIA ontology research using remote 
sensing \citep{Bobillo2011, Bobillo2015}. More recently a multi-scale fuzzy 
spatial reasoner was developed which could have significant impact on this 
...
that seeks to harmonize land cover and land use class (LC/LU) nomenclatures 
...
different nomenclatures used in Europe each have their own specific 
...
ontology. The combination of data mining algorithms with ontology-based 
classification using EUNIS and EAGLE concepts has, to our knowledge, not yet 
been done and is a first in remote sensing research. This method
...
pre-segmented polygons. The advantages of using an OWL2 ontology is also 
discussed.
...
wetness indicator as an example. We combined
agricultural, foresty, biotope and geological data from different sources, 
creating a comprehensive database for Rhineland Palatinate.
The method was tested on the Saarburg district area  as shown in 
\ref{fig_study_area}.
...
An overview of the complete workflow is shown in figure 
...
translated into an OWL2 ontology for 
use with a reasoner. 
...
%\citep{scikit-learn} or SEaTH algorithm
...
segmentation alorithm for testing and training. 
