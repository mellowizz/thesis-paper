...
% In der Graphik würde ich Parameters durch indicators ersetzen.
\begin{figure}
...
etc.). To encsure the comparablity of these base data sets they were
characterised with a common reference model of indictors, which have been
developed within the NATFLO project.  These polygons are much larger than the
polygons produced by the segmentation (see \ref{subsec:reference_data_and_semantic_characterisation}, so that all polygons completely within the thematically combined polygon receives all of its
