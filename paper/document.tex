\documentclass[authoryear,final,12pt,number]{elsarticle}
...
of indicators to be derived and aggregated to form
\gls{eunis} classes.
\begin{table}
%Die erste Spalte wuerde ich rausnehmen. Das ist doppelt!
\centering
...
\end{table}
All described processes are based on a pre-segmentated data set, generated using
\gls{geobia}. 
...
\gls{lidar} ASCII point clouds acquired between 2003 and 2009 with a resolution
of 0.2m. The reference data (see 
...
%hier fehlt noch die Erstellung der Referenzdaten.
