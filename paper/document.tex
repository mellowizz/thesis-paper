...
\begin{table}\footnotesize%[ht]
\centering
  \begin{tabular}{l l l}
Description & EUNIS Class & Indicators \\
\hline
\multirow{3}{*}{Dry Grasslands} & E1 & wetness, vegetation type \\ 
    & E1.1 & wetness, vegetation type, immature soil, hydromorphic \\ 
    & E1.2 & wetness, vegetation type, immature soil depression, hydromorphic\\
\multirow{3}{*}{Mesic grasslands} & E2 & wetness, vegetation type, depression,
immature soil, hydromorphic\\
    & E2.1 & wetness, vegetation type, depression, usage, usage intensity,
    hydromorphic \\ 
    & E2.3 & wetness, vegetation type, usage, immature soil, depression,
    hydromorphic \\
    &  E2.7 & wetness, vegetation type, usage, species rich, immature soil,
    depression, hydromorphic \\
\multirow{3}{*}{Seasonally wet and wet grasslands} & E3 &wetness vegetation
type, usage, species rich, immature soil, depression, hydromorphic\\
    & E3.4 &  wetness, vegetation type, usage, species rich, immature soil,
    depression, hydromorphic \\ 
    & E3.5 & wetness, type, usage, species rich, immature soil, depression,
    hydromorphic\\
\end{tabular}
%\end{center}
...
``Sub-Atlantic lowland hay meadows'' modelled with selected remote sensing indicators is written in description logic (DL) below:
%\begin{equation}
\begin{align*}
%\begin{split}
