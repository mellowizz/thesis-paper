...
We compare the results of the SEaTH tool with the randomForest classifier 
...
\begin{figure}
	\includegraphics[height=0.5, width=\textwidth]{diagrams/study_area_small.png}
\end{figure}
...
algorithms chose very different features as important. To compare results
most adequately the automated dataset generated for SEaTH classification
and rule generation was classified using RandomForest.
\section{Discussion}
